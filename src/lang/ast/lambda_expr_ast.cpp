...
void lambda_expr::visit_children(const std::function<void(const base_ast&)>& f) const
{
...
semantic_analysis_result lambda_expr::do_semantic_analysis(sema_ctx& c) const
{
